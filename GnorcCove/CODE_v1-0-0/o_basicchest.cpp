...
{
    MDL_BasicChest = LoadBasicModel("BasicChest");
    MDL_BCDebris01 = LoadBasicModel("BCDebris01");
    MDL_BCDebris02 = LoadBasicModel("BCDebris02");
    MDL_BCDebris03 = LoadBasicModel("BCDebris03");
    MDL_Number5 = LoadBasicModel("Number5");
