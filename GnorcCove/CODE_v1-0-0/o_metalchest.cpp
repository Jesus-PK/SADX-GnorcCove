...
{
    MDL_MetalChest = LoadBasicModel("MetalChest");
    MDL_MCDebris01 = LoadBasicModel("MCDebris01");
    MDL_MCDebris02 = LoadBasicModel("MCDebris02");
    MDL_MCDebris03 = LoadBasicModel("MCDebris03");
    MDL_Number10 = LoadBasicModel("Number10");
