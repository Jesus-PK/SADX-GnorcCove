...
void LOAD_TNTBarrel()
{
    MDL_TNTBarrel = LoadBasicModel("TNTBarrel");
    MDL_TNTDebris01 = LoadBasicModel("TNTDebris01");
    MDL_TNTDebris02 = LoadBasicModel("TNTDebris02");
    MDL_TNTDebris03 = LoadBasicModel("TNTDebris03");
    MDL_TNTDebris04 = LoadBasicModel("TNTDebris04");
    MDL_TNTDebris05 = LoadBasicModel("TNTDebris05");
