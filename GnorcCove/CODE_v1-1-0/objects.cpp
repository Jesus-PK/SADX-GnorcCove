...
TEX_PVMTABLE TEXTURELIST_GnorcCove[] = {
	...
	{ "BG_SHAREOBJ", (TexList*)0x38A6BE8 }, // It isn't neccessary to load the skybox .PVM since my custom code doesn't call for any texlist for the skybox, but may as well leave it just in case.
