...
NJS_TEXNAME TEX_GnorcCove_Objects[40] = { 0 };
NJS_TEXLIST TEXLIST_GnorcCove_Objects = { arrayptrandlength(TEX_GnorcCove_Objects) };

NJS_TEXNAME TEX_GnorcCove_Dragons[4] = { 0 };
NJS_TEXLIST TEXLIST_GnorcCove_Dragons = { arrayptrandlength(TEX_GnorcCove_Dragons) };
...
_OBJ_ITEMENTRY OBJECTLIST_GnorcCove_Entries[] = {
	...
	{ 2, 2, 1, 4000000.0f, 0, EXEC_GnorcCove_Platform, "O GNORC COVE PLATFORM" }, // ID 37
	{ 2, 2, 1, 4000000.0f, 0, EXEC_GnorcCove_Door, "O GNORC COVE DOOR" }, // ID 38
...
TEX_PVMTABLE TEXTURELIST_GnorcCove[] = {
	...
	{ "GnorcCove_Objects", &TEXLIST_GnorcCove_Objects },
	{ "GnorcCove_Dragons", &TEXLIST_GnorcCove_Dragons },
