...
//	Custom LevelOBJ - Replacement code for Twinkle Park levelOBJ function (0x61D150):
//	Since my intention is to replace completely the vanilla levelOBJ, I will do a WriteJump instead of FuncHooking the function. If I wanted to let the original code run at any point, I would FuncHook it instead of WriteJumping it.
