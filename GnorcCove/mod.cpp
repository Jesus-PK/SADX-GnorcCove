...
extern "C"
{
	__declspec(dllexport) void __cdecl Init(const char* path, const HelperFunctions& helperFunctions)
	{
		...
		//	Custom LevelOBJ - "If you reach the function Obj_TwinklePark, jump to my function instead" - Sora_yx 2023 (This is the WriteJump for my custom LevelOBJ):
		...
		//	Custom Skybox:
			...
			WriteJump((void*)0x61D1F0, SKYBOX_GnorcCove);
