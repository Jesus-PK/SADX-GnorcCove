...
void LOAD_LifeChest()
{
    MDL_LifeChest = LoadBasicModel("GnorcCove_LifeChest");
    MDL_LCDebris01 = LoadBasicModel("GnorcCove_LCDebris01");
    MDL_LCDebris02 = LoadBasicModel("GnorcCove_LCDebris02");
    MDL_LCDebris03 = LoadBasicModel("GnorcCove_LCDebris03");
    MDL_LifeStatue = LoadBasicModel("GnorcCove_LifeStatue");
    ANIM_LifeChest = LoadObjectAnim("GnorcCove_LifeChest");
