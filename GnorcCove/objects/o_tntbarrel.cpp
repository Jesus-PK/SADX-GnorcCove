...
void LOAD_TNTBarrel()
{
    MDL_TNTBarrel = LoadBasicModel("GnorcCove_TNTBarrel");
    MDL_TNTDebris01 = LoadBasicModel("GnorcCove_TNTDebris01");
    MDL_TNTDebris02 = LoadBasicModel("GnorcCove_TNTDebris02");
    MDL_TNTDebris03 = LoadBasicModel("GnorcCove_TNTDebris03");
    MDL_TNTDebris04 = LoadBasicModel("GnorcCove_TNTDebris04");
    MDL_TNTDebris05 = LoadBasicModel("GnorcCove_TNTDebris05");
