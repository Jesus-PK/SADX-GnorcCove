        ...
        case 1:
        {
            if (CheckCollisionP(&POS_LKCTrigger, 10.0f))
            {
                ...
                else
                {
                    ...
                    CreateChildrenTask(CTS_ItemMagneticBarrier, tp);
...
{
    MDL_LockedChest = LoadBasicModel("GnorcCove_LockedChest");
    MDL_LKCLid = LoadBasicModel("GnorcCove_LKCLid");
    MDL_LKCDebris01 = LoadBasicModel("GnorcCove_LKCDebris01");
    MDL_LKCDebris02 = LoadBasicModel("GnorcCove_LKCDebris02");
    MDL_LKCDebris03 = LoadBasicModel("GnorcCove_LKCDebris03");
    MDL_LKCDebris04 = LoadBasicModel("GnorcCove_LKCDebris04");
    MDL_ItemMagneticBarrier = LoadBasicModel("GnorcCove_ItemMagneticBarrier");
    MDL_LKCKey = LoadBasicModel("GnorcCove_LKCKey");
    MDL_LKCColli01 = LoadBasicModel("GnorcCove_LKCColli01");
    MDL_LKCColli02 = LoadBasicModel("GnorcCove_LKCColli02");
