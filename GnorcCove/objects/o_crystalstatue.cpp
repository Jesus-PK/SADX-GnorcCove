...
{
    MDL_CrystalBase = LoadBasicModel("GnorcCove_CrystalBase");
    
    MDL_CrystalStatue = LoadBasicModel("GnorcCove_CrystalStatue");
    MDL_CSDebris01 = LoadBasicModel("GnorcCove_CSDebris01");
    MDL_CSDebris02 = LoadBasicModel("GnorcCove_CSDebris02");
    MDL_CSDebris03 = LoadBasicModel("GnorcCove_CSDebris03");
